 ...
 */
export function getBreakpointFromWith(breakpoints, width) {
 ...
 */
export function findOrGenerateResponsiveLayout(layouts, breakpoints, breakpoint, lastBreakpoint, cols, verticalCompact) {
