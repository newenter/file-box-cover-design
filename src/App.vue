...
<script>
import RulerTool from './components/ruler-tool'
...
export default {
	...
	methods: {
		...
		move: function(i, newX, newY){
			console.log("MOVE i=%s, X=%s, Y=%s", i, newX, newY);
		},
		resize: function(i, newH, newW, newHPx, newWPx){
			console.log("RESIZE i=%s, H=%s, W=%s, H(px)=%s, W(px)=%s", i, newH, newW, newHPx, newWPx);
		},
		moved: function(i, newX, newY){
			console.log("### MOVED i=%s, X=%s, Y=%s", i, newX, newY);
		},
		resized: function(i, newH, newW, newHPx, newWPx){
			console.log("### RESIZED i=%s, H=%s, W=%s, H(px)=%s, W(px)=%s", i, newH, newW, newHPx, newWPx);
		},
	}
}
</script>
